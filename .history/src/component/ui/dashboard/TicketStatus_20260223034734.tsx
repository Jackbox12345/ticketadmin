      ...
      {loading ? (
        ...
        <div className="space-y-2 flex justify-between flex-col" >
          <p className="text-lg font-semibold flex justify-between flex-row">
            {ticketStatus.openCount} <span>Open</span>
          </p>
          <p className="text-lg font-semibold flex justify-between flex-row">
            {ticketStatus.resolveCount} <span>Resolve</span>
          </p>
          <p className="text-lg font-semibold flex justify-around flex-row">
            {ticketStatus.pendingCount} <span>Pending</span>
          </p>
        </div>
      ) : (
        <p>No data</p>
