...
const MainSection = () => {
  ...
  return (
    <main className="flex-1 bg-[#1b1433] text-white p-6 space-y-6">
      ...
      <div className="grid grid-cols-2 gap6">
        <Card>
        <ChartHeader value={range} onChange={setRange} />
        </Card>
      <Card className="rounded-xl p-6 flex flex-col justify-between h-full">
          <h3 className="text-lg text-center text-white-500">Total Tickets</h3>

          <div className="flex items-center justify-center flex-1">
            <span className="text-4xl font-bold">95%</span>
          </div>

          <span className="text-lg text-center text-white-500">Tickets </span>
        </Card>
